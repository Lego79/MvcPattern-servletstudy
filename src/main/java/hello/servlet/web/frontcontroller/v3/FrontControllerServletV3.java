...
@WebServlet(name = "frontControllerServletV3", urlPatterns = "/front-controller/v3/*")// *을 사용하면 하위에 어떤 url이 들어와도 무조건 이 컨트롤러가 호출 됨
public class FrontControllerServletV3 extends HttpServlet {

    private Map<String, ControllerV3> controllerMap = new HashMap<>();  //매핑정보 - url, 키는 url, 어떤 url 이ㅣ 들어오면 controller 인터페이스 호출

    public FrontControllerServletV3() { //매핑정보 생성할때 미리 담아놓는다, 서블릿 생성될 떄
